...
How to run (instructions from https://github.com/LIAAD/our_yake):
	
	1. Install everything using pip:
		pip install git+https://github.com/LIAAD/our_yake
...
"""
import argparse
from our_yake.yake_test import yakeTest
from our_yake.yake_by_us import transcriptsToKeywords
from our_yake.utils import csvToTranscripts, keywordsTocsv
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser()
    # Main arguments
    parser.add_argument('--test', default=False, type=bool, help='Run our_yake on dummy text')
    parser.add_argument('--csv', default=True, type=bool, help='Run our_yake on testing 298 row csv')
    parser.add_argument('--csv_input_file', default=csv_file_path, type=str, help="Name of csv file to use as input.")
    parser.add_argument('--csv_output_file', default=csv_keyword_output, type=str,
                        help="Name of csv file to use as output.")
    ...
    print(yake_keywords(
        "Het was een zware ochtend. Om 7 uur ging de wekker die mij met blauwe ogen het bed uit lokte. Eenmaal aangekomen op werk werd ik door een dubbele espresso verrast.",
        n=3))
